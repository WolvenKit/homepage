...
<ul>
  ...
  <li>
    <p>
      ...
      form the entire agreement between You and the Company regarding the use of the Service. This Terms and Conditions
  ...
  <li>
    <p>
      ...
      <a href="redmodding.org" rel="external nofollow noopener" target="_blank">redmodding.org</a>
    </p>
  </li>
  <li>
    <p>
...
<p>
  ...
  Terms shall not affect a party's ability to exercise such right or require such performance at any time thereafter nor
...
<ul>
  <li>By email: contact@redmodding.org or moonded@moonded.com</li>
</ul>
