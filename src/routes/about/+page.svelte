...
<PageRoot title="About us" description="What is Red Modding? Who is it? When is it?">
  <div class="flex w-full flex-row flex-wrap">
    <div class="-mt-4 inline-block w-1/3 text-right">
      <Heading level={2} class="m-0 text-center">Timeline</Heading>
    ...
    <div class="content -my-12 text-xl leading-relaxed text-zinc-300">
      <p>
        ...
        customization. Then <strong>Cyberpunk 2077</strong> dropped, and our community exploded in the best way possible,
        adapting WolvenKit to the new game’s REDengine with the help of our brilliant and dedicated developers.
      </p>
      <p>
        Lead by the legend, <em>Ryan Fuzzling</em> and his laid-back yet inspiring vibe our
        <strong>Discord server</strong> shaped into a&nbsp;hub of <strong>collaboration</strong>,
      ...
      <figure class="m-8 max-w-[640px] text-center lg:float-right 2xl:-mr-36">
        <Image
          src={redengine}
          width={640}
          height={360}
      ...
      <p>
        ...
        <Button inline href="/projects">Blender plugin</Button> streamlines <strong>3D modeling</strong>, making it
        easier than ever to create and edit assets for the game. But that’s just the tip of the iceberg. We’ve developed
      ...
      <p>
        ...
        <strong>large language AI model</strong> known as <em>Mana</em>. The wiki hosts
        <strong>detailed guides</strong>,
      ...
      <div class="text-center text-zinc-400">
        Please note that the above content is of illustrative character and may not represent the real events
        accurately.
      </div>
    </div>
  </div>
