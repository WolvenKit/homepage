<script lang="ts">
  ...
  let { teamId, team, class: classes = "", onClick }: Props = $props();

  let teamInfo = $derived(team || teams[teamId]);
</script>
...
{:else if "color" in teamInfo && teamInfo.color}
  ...
  >
    ...
    <path
      ...
      fill="none"
      stroke={teamId == "blender" ? "#f17223" : "white"}
      stroke-width="64"
    />
    <path
      d="m512.6 92.17-.5931 419.8 358 210.4"
      fill="none"
      stroke={teamId == "blender" ? "#f17223" : "white"}
      stroke-width="64"
    />
    <path
      d="m153.4 721.4 358.6-209.4"
      fill="none"
      stroke={teamId == "blender" ? "#f17223" : "white"}
      stroke-width="64"
    />
